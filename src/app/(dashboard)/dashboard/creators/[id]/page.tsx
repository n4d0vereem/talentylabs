...
// Composant sortable pour les todos
...
export default function CreatorProfilePage() {
  ...
  // Gérer la fin du drag pour les collaborations
  ...
  // Gérer la fin du drag pour les todos
